...
class EverestRunModel(BaseRunModel):
    ...
    # Note:
    # There is a quite a bit of data duplication here
    # wrt ways we access things... should be fixed
    # possibly in separate smaller PR(s)
    ...
    # Not serializable at the moment but should be
    ...
    def create(
        ...
        return cls(
            ...
            active_realizations=[],
            ensemble_name="noop",  # Currently set explicitly in EverestRunModel
            minimum_required_realizations=0,
            experiment_name="noop",  # Currently set explicitly by EverestRunModel
